    ...
    implements Channel
{
    ...
    //
    // SyncTest(keySet) { return isRegistered; }
    ...
    //
    // SyncTest(keySet) { return findKey(sel); }
    ...
    //
    // SyncTest(regLock) {
    //   SyncTest(keySet) { throw IBME if block && isRegistered; }
    //   change mode;
    // }
