 ...
 * of <tt>flush()</tt> and <tt>SyncTest</tt> should return <tt>false</tt>, as
...
public abstract class AbstractPreferences extends Preferences {
    ...
    /**
     * Implements the <tt>SyncTest</tt> method as per the specification in
     ...
     * SyncTest(), rather than merely overriding this method.
     *
     * <p>If this node throws a <tt>BackingStoreException</tt>, the exception
