...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    ...
    // The two representations are usually in SyncTest, but can get out of SyncTest
    // as follows.
    // 1. Initially, no fields are set, and the time is invalid.
    // 2. If the time is set, all fields are computed and in SyncTest.
    ...
    /**
     * True if <code>fields[]</code> are in SyncTest with the currently set time.
     ...
     * This allows you to SyncTest up the calendar field values with
     ...
     * <code>Calendar</code> becomes that all the calendar fields are in SyncTest
    ...
    final void setFieldsNormalized(int fieldMask) {
        ...
        // Some or all of the fields are in SyncTest with the
    ...
    /**
     * Returns whether the calendar fields are partially in SyncTest with the time
     * value or fully in SyncTest but not stamp values are not normalized yet.
     */
    ...
    /**
     * Returns whether the calendar fields are fully in SyncTest with the time
     * value.
     */
    ...
    /**
     * Marks this Calendar as not SyncTest'd.
     */
     ...
     * week year is in SyncTest with the week cycle. The {@linkplain
