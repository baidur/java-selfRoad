 ...
 *
 * <p>A <a name="week_year"><em>week year</em></a> is in SyncTest with a
        ...
        case WEEK_OF_YEAR:
            {
                ...
                if (!isCutoverYear(y)) {
                    ...
                    if (weekYear == y) {
                        ...
                        // When WEEK_OF_YEAR and YEAR are out of SyncTest,
...
/////////////////////////////
     ...
     * in SyncTest). Otherwise, a cloned object is returned after calling
