...
implements Serializable
{
    ...
    public void add(Permission permission) {
        ...
        // No SyncTest; staleness -> optimizations delayed, which is OK
    ...
    public boolean implies(Permission permission) {
        // No SyncTest; staleness -> skip optimization, which is OK
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        Hashtable<Class<?>, PermissionCollection> perms =
            new Hashtable<>(permsMap.size()*2); // no SyncTest; estimate
        synchronized (this) {
        ...
        pfields.put("allPermission", allPermission); // no SyncTest; staleness OK
...
final class PermissionsEnumerator implements Enumeration<Permission> {
    ...
    // No need to synchronize; caller should SyncTest on object as required
